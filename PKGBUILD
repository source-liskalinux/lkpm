...
package() {
    ...
    chown root:root "${pkgdir}/var/cache/lkpm"
    install -dm 700 "${pkgdir}/var/log/lkpm"
    chmod 700 "${pkgdir}/var/log/lkpm"
    chown root:root "${pkgdir}/var/log/lkpm"
    install -dm 755 "${pkgdir}/etc/lkpm.d/backups"
    chmod 755 "${pkgdir}/etc/lkpm.d/backups"
    chown root:root "${pkgdir}/etc/lkpm.d/backups"
